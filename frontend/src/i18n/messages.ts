...
export const messages = {
  ...
  'tool.person': 'Person',
  'tool.cloud': 'Cloud',
  'style.toolbar': 'Colours',
  'style.fill': 'Fill colour',
  'style.stroke': 'Border colour',
  'style.color': 'Text colour',
  'style.custom': 'Custom',
  'style.customHint': '#rrggbb',
  'style.opacity': 'Opacity',
  'style.language': 'Language',
  'style.strokeWidth': 'Stroke width',
  'style.strokeStyle': 'Line style',
  'style.edges': 'Edges',
  'style.fontSize': 'Text size',
  'style.align': 'Alignment',
  'style.verticalAlign': 'Vertical alignment',
  'style.arrowType': 'Arrow type',
  'style.startArrowhead': 'Start head',
  'style.endArrowhead': 'End head',
  // The choices a style property offers, in `canvas/property-options.ts`.
  'option.thin': 'Thin',
  ...
  'option.triangle-outline': 'Triangle outline',
  'option.circle': 'Circle',
  'option.circle-outline': 'Circle outline',
  'option.diamond': 'Diamond',
  'option.diamond-outline': 'Diamond outline',
  ...
  'align.top': 'Align top',
  'align.middle': 'Centre vertically',
  'align.bottom': 'Align bottom',
  'align.distributeHorizontal': 'Distribute horizontally',
  'align.distributeVertical': 'Distribute vertically',
  ...
  'export.dark': 'Dark mode',
  'export.scale': 'Scale',
  'export.scalePng': 'Scale (PNG)',
  'export.png': 'PNG',
  'export.svg': 'SVG',
  ...
  'about.close': 'Close',
  'launch.label': 'Bava is starting',
  'progress.value': '{label} {percent}%',
  'launch.starting': 'Starting',
  'launch.footer': 'Apache-2.0 · offline',
  'empty.noFile.title': 'No file open',
  'empty.noFile.open': 'Open a file',
  'empty.noFile.new': 'New file',
